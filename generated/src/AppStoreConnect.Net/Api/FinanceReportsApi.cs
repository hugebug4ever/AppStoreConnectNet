...
namespace AppStoreConnect.Net.Api
{
    ...
    public interface IFinanceReportsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileParameter> FinanceReportsGetCollectionAsync(List<string> filterVendorNumber, List<string> filterReportType, List<string> filterRegionCode, List<string> filterReportDate, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> FinanceReportsGetCollectionWithHttpInfoAsync(List<string> filterVendorNumber, List<string> filterReportType, List<string> filterRegionCode, List<string> filterReportDate, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class FinanceReportsApi : IDisposable, IFinanceReportsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> FinanceReportsGetCollectionAsync(List<string> filterVendorNumber, List<string> filterReportType, List<string> filterRegionCode, List<string> filterReportDate, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<AppStoreConnect.Net.Client.ApiResponse<FileParameter>> FinanceReportsGetCollectionWithHttpInfoAsync(List<string> filterVendorNumber, List<string> filterReportType, List<string> filterRegionCode, List<string> filterReportDate, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'filterVendorNumber' is set
            if (filterVendorNumber == null)
                throw new AppStoreConnect.Net.Client.ApiException(400, "Missing required parameter 'filterVendorNumber' when calling FinanceReportsApi->FinanceReportsGetCollection");
