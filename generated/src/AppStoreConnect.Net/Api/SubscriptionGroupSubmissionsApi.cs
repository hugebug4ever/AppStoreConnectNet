...
namespace AppStoreConnect.Net.Api
{
    ...
    public interface ISubscriptionGroupSubmissionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SubscriptionGroupSubmissionResponse> SubscriptionGroupSubmissionsCreateInstanceAsync(SubscriptionGroupSubmissionCreateRequest subscriptionGroupSubmissionCreateRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<SubscriptionGroupSubmissionResponse>> SubscriptionGroupSubmissionsCreateInstanceWithHttpInfoAsync(SubscriptionGroupSubmissionCreateRequest subscriptionGroupSubmissionCreateRequest, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class SubscriptionGroupSubmissionsApi : IDisposable, ISubscriptionGroupSubmissionsApi
    {
        ...
        /// <returns></returns>
        public SubscriptionGroupSubmissionsApi(AppStoreConnect.Net.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SubscriptionGroupSubmissionsApi(HttpClient client, AppStoreConnect.Net.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public SubscriptionGroupSubmissionsApi(AppStoreConnect.Net.Client.ISynchronousClient client, AppStoreConnect.Net.Client.IAsynchronousClient asyncClient, AppStoreConnect.Net.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            AppStoreConnect.Net.Client.ApiResponse<SubscriptionGroupSubmissionResponse> localVarResponse = SubscriptionGroupSubmissionsCreateInstanceWithHttpInfo(subscriptionGroupSubmissionCreateRequest);
        ...
        /// <param name="subscriptionGroupSubmissionCreateRequest">SubscriptionGroupSubmission representation</param>
        /// <returns>ApiResponse of SubscriptionGroupSubmissionResponse</returns>
        public AppStoreConnect.Net.Client.ApiResponse<SubscriptionGroupSubmissionResponse> SubscriptionGroupSubmissionsCreateInstanceWithHttpInfo(SubscriptionGroupSubmissionCreateRequest subscriptionGroupSubmissionCreateRequest)
        {
            ...
            if (subscriptionGroupSubmissionCreateRequest == null)
                throw new AppStoreConnect.Net.Client.ApiException(400, "Missing required parameter 'subscriptionGroupSubmissionCreateRequest' when calling SubscriptionGroupSubmissionsApi->SubscriptionGroupSubmissionsCreateInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SubscriptionGroupSubmissionResponse</returns>
        public async System.Threading.Tasks.Task<SubscriptionGroupSubmissionResponse> SubscriptionGroupSubmissionsCreateInstanceAsync(SubscriptionGroupSubmissionCreateRequest subscriptionGroupSubmissionCreateRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            AppStoreConnect.Net.Client.ApiResponse<SubscriptionGroupSubmissionResponse> localVarResponse = await SubscriptionGroupSubmissionsCreateInstanceWithHttpInfoAsync(subscriptionGroupSubmissionCreateRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SubscriptionGroupSubmissionResponse)</returns>
        public async System.Threading.Tasks.Task<AppStoreConnect.Net.Client.ApiResponse<SubscriptionGroupSubmissionResponse>> SubscriptionGroupSubmissionsCreateInstanceWithHttpInfoAsync(SubscriptionGroupSubmissionCreateRequest subscriptionGroupSubmissionCreateRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'subscriptionGroupSubmissionCreateRequest' is set
            if (subscriptionGroupSubmissionCreateRequest == null)
                throw new AppStoreConnect.Net.Client.ApiException(400, "Missing required parameter 'subscriptionGroupSubmissionCreateRequest' when calling SubscriptionGroupSubmissionsApi->SubscriptionGroupSubmissionsCreateInstance");
