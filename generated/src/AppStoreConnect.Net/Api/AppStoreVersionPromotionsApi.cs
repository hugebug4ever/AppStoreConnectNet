...
namespace AppStoreConnect.Net.Api
{
    ...
    public interface IAppStoreVersionPromotionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AppStoreVersionPromotionResponse> AppStoreVersionPromotionsCreateInstanceAsync(AppStoreVersionPromotionCreateRequest appStoreVersionPromotionCreateRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<AppStoreVersionPromotionResponse>> AppStoreVersionPromotionsCreateInstanceWithHttpInfoAsync(AppStoreVersionPromotionCreateRequest appStoreVersionPromotionCreateRequest, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class AppStoreVersionPromotionsApi : IDisposable, IAppStoreVersionPromotionsApi
    {
        ...
        /// <returns></returns>
        public AppStoreVersionPromotionsApi(AppStoreConnect.Net.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public AppStoreVersionPromotionsApi(HttpClient client, AppStoreConnect.Net.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public AppStoreVersionPromotionsApi(AppStoreConnect.Net.Client.ISynchronousClient client, AppStoreConnect.Net.Client.IAsynchronousClient asyncClient, AppStoreConnect.Net.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            AppStoreConnect.Net.Client.ApiResponse<AppStoreVersionPromotionResponse> localVarResponse = AppStoreVersionPromotionsCreateInstanceWithHttpInfo(appStoreVersionPromotionCreateRequest);
        ...
        /// <param name="appStoreVersionPromotionCreateRequest">AppStoreVersionPromotion representation</param>
        /// <returns>ApiResponse of AppStoreVersionPromotionResponse</returns>
        public AppStoreConnect.Net.Client.ApiResponse<AppStoreVersionPromotionResponse> AppStoreVersionPromotionsCreateInstanceWithHttpInfo(AppStoreVersionPromotionCreateRequest appStoreVersionPromotionCreateRequest)
        {
            // verify the required parameter 'appStoreVersionPromotionCreateRequest' is set
            if (appStoreVersionPromotionCreateRequest == null)
                throw new AppStoreConnect.Net.Client.ApiException(400, "Missing required parameter 'appStoreVersionPromotionCreateRequest' when calling AppStoreVersionPromotionsApi->AppStoreVersionPromotionsCreateInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AppStoreVersionPromotionResponse</returns>
        public async System.Threading.Tasks.Task<AppStoreVersionPromotionResponse> AppStoreVersionPromotionsCreateInstanceAsync(AppStoreVersionPromotionCreateRequest appStoreVersionPromotionCreateRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            AppStoreConnect.Net.Client.ApiResponse<AppStoreVersionPromotionResponse> localVarResponse = await AppStoreVersionPromotionsCreateInstanceWithHttpInfoAsync(appStoreVersionPromotionCreateRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AppStoreVersionPromotionResponse)</returns>
        public async System.Threading.Tasks.Task<AppStoreConnect.Net.Client.ApiResponse<AppStoreVersionPromotionResponse>> AppStoreVersionPromotionsCreateInstanceWithHttpInfoAsync(AppStoreVersionPromotionCreateRequest appStoreVersionPromotionCreateRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'appStoreVersionPromotionCreateRequest' is set
            if (appStoreVersionPromotionCreateRequest == null)
                throw new AppStoreConnect.Net.Client.ApiException(400, "Missing required parameter 'appStoreVersionPromotionCreateRequest' when calling AppStoreVersionPromotionsApi->AppStoreVersionPromotionsCreateInstance");
