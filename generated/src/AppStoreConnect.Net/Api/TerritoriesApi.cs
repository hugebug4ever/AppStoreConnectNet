...
namespace AppStoreConnect.Net.Api
{
    ...
    public interface ITerritoriesApiSync : IApiAccessor
    {
        ...
        TerritoriesResponse TerritoriesGetCollection(List<string>? fieldsTerritories = default, int? limit = default);
        ...
        ApiResponse<TerritoriesResponse> TerritoriesGetCollectionWithHttpInfo(List<string>? fieldsTerritories = default, int? limit = default);
    ...
    public interface ITerritoriesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TerritoriesResponse> TerritoriesGetCollectionAsync(List<string>? fieldsTerritories = default, int? limit = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<TerritoriesResponse>> TerritoriesGetCollectionWithHttpInfoAsync(List<string>? fieldsTerritories = default, int? limit = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class TerritoriesApi : IDisposable, ITerritoriesApi
    {
        ...
        /// <returns></returns>
        public TerritoriesApi(AppStoreConnect.Net.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TerritoriesApi(HttpClient client, AppStoreConnect.Net.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public TerritoriesApi(AppStoreConnect.Net.Client.ISynchronousClient client, AppStoreConnect.Net.Client.IAsynchronousClient asyncClient, AppStoreConnect.Net.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="limit">maximum resources per page (optional)</param>
        /// <returns>TerritoriesResponse</returns>
        public TerritoriesResponse TerritoriesGetCollection(List<string>? fieldsTerritories = default, int? limit = default)
        {
            AppStoreConnect.Net.Client.ApiResponse<TerritoriesResponse> localVarResponse = TerritoriesGetCollectionWithHttpInfo(fieldsTerritories, limit);
        ...
        /// <param name="limit">maximum resources per page (optional)</param>
        /// <returns>ApiResponse of TerritoriesResponse</returns>
        public AppStoreConnect.Net.Client.ApiResponse<TerritoriesResponse> TerritoriesGetCollectionWithHttpInfo(List<string>? fieldsTerritories = default, int? limit = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TerritoriesResponse</returns>
        public async System.Threading.Tasks.Task<TerritoriesResponse> TerritoriesGetCollectionAsync(List<string>? fieldsTerritories = default, int? limit = default, System.Threading.CancellationToken cancellationToken = default)
        {
            AppStoreConnect.Net.Client.ApiResponse<TerritoriesResponse> localVarResponse = await TerritoriesGetCollectionWithHttpInfoAsync(fieldsTerritories, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TerritoriesResponse)</returns>
        public async System.Threading.Tasks.Task<AppStoreConnect.Net.Client.ApiResponse<TerritoriesResponse>> TerritoriesGetCollectionWithHttpInfoAsync(List<string>? fieldsTerritories = default, int? limit = default, System.Threading.CancellationToken cancellationToken = default)
        {
