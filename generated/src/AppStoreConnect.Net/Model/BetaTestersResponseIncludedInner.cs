...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaTestersResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return BetaTestersResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
