...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionPhasedReleaseAttributes : IValidatableObject
    {
        ...
        public AppStoreVersionPhasedReleaseAttributes(PhasedReleaseState? phasedReleaseState = default, DateTimeOffset startDate = default, int totalPauseDuration = default, int currentDayNumber = default)
        {
