...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreReviewAttachmentAttributes : IValidatableObject
    {
        ...
        public AppStoreReviewAttachmentAttributes(int fileSize = default, string fileName = default, string sourceFileChecksum = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default)
        {
