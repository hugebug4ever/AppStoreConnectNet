...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppEventScreenshot_attributes")]
    public partial class AppEventScreenshotAttributes : IValidatableObject
    {
        ...
        public AppEventScreenshotAttributes(int fileSize = default, string fileName = default, ImageAsset imageAsset = default, string assetToken = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default, AppEventAssetType? appEventAssetType = default)
        {
