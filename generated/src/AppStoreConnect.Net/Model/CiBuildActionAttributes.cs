...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiBuildActionAttributes : IValidatableObject
    {
        ...
        public CiBuildActionAttributes(string name = default, CiActionType? actionType = default, DateTimeOffset startedDate = default, DateTimeOffset finishedDate = default, CiIssueCounts issueCounts = default, CiExecutionProgress? executionProgress = default, CiCompletionStatus? completionStatus = default, bool isRequiredToPass = default)
        {
            this.Name = name;
