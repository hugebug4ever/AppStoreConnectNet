...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventLocalizationCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public AppEventLocalizationCreateRequestDataAttributes(string locale = default, string name = default, string shortDescription = default, string longDescription = default)
        {
