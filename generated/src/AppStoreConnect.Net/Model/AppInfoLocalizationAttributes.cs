...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppInfoLocalizationAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppInfoLocalizationAttributes(string locale = default, string name = default, string subtitle = default, string privacyPolicyUrl = default, string privacyChoicesUrl = default, string privacyPolicyText = default)
        {
            this.Locale = locale;
            this.Name = name;
