...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public AppEventUpdateRequestDataAttributes(string referenceName = default, BadgeEnum? badge = default, string deepLink = default, string purchaseRequirement = default, string primaryLocale = default, PriorityEnum? priority = default, PurposeEnum? purpose = default, List<AppEventAttributesTerritorySchedulesInner> territorySchedules = default)
        {
