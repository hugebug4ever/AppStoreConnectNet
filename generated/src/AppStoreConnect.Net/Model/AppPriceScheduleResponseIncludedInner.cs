...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppPriceScheduleResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(AppPriceV2) || value is AppPriceV2)
                {
                    this._actualInstance = value;
                }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return AppPriceScheduleResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
