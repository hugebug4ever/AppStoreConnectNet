...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaAppReviewSubmissionRelationships : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaAppReviewSubmissionRelationships" /> class.
        /// </summary>
        /// <param name="build">build.</param>
        public BetaAppReviewSubmissionRelationships(AppStoreVersionRelationshipsBuild build = default)
        {
            this.Build = build;
        }
