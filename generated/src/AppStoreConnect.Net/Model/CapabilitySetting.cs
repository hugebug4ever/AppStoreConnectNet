...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CapabilitySetting : IValidatableObject
    {
        /// <summary>
        /// Defines Key
        /// </summary>
        ...
        public CapabilitySetting(KeyEnum? key = default, string name = default, string description = default, bool enabledByDefault = default, bool visible = default, AllowedInstancesEnum? allowedInstances = default, int minInstances = default, List<CapabilityOption> options = default)
        {
            this.Key = key;
            this.Name = name;
