...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public SubscriptionCreateRequestDataAttributes(string name = default, string productId = default, bool? familySharable = default, SubscriptionPeriodEnum? subscriptionPeriod = default, string reviewNote = default, int? groupLevel = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "reviewNote", EmitDefaultValue = true)]
        public string ReviewNote { get; set; }

        /// <summary>
        /// Gets or Sets GroupLevel
        /// </summary>
        [DataMember(Name = "groupLevel", EmitDefaultValue = true)]
