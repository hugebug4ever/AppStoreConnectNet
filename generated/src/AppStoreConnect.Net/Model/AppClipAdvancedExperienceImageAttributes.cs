...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppClipAdvancedExperienceImage_attributes")]
    public partial class AppClipAdvancedExperienceImageAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppClipAdvancedExperienceImageAttributes(int fileSize = default, string fileName = default, string sourceFileChecksum = default, ImageAsset imageAsset = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default)
        {
