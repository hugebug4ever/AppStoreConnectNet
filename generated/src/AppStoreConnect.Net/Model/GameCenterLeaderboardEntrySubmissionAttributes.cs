...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameCenterLeaderboardEntrySubmission_attributes")]
    public partial class GameCenterLeaderboardEntrySubmissionAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public GameCenterLeaderboardEntrySubmissionAttributes(string bundleId = default, List<string> challengeIds = default, decimal context = default, string scopedPlayerId = default, decimal score = default, DateTimeOffset submittedDate = default, string vendorIdentifier = default)
        {
