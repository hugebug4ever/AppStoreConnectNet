...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionUpdateRequestDataRelationships : IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreVersionUpdateRequestDataRelationships(AppStoreVersionCreateRequestDataRelationshipsBuild build = default, AppClipAppStoreReviewDetailRelationshipsAppClipDefaultExperience appClipDefaultExperience = default)
        {
            this.Build = build;
