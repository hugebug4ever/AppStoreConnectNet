...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiBuildRunAttributesSourceCommit : IValidatableObject
    {
        ...
        public CiBuildRunAttributesSourceCommit(string commitSha = default, string message = default, CiGitUser author = default, CiGitUser committer = default, string webUrl = default)
        {
