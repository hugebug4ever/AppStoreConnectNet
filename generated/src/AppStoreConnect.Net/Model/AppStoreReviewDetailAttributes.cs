...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreReviewDetailAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreReviewDetailAttributes(string contactFirstName = default, string contactLastName = default, string contactPhone = default, string contactEmail = default, string demoAccountName = default, string demoAccountPassword = default, bool demoAccountRequired = default, string notes = default)
        {
