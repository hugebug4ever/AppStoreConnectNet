...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionExperimentV2Attributes : IValidatableObject
    {
        ...
        public AppStoreVersionExperimentV2Attributes(string name = default, Platform? platform = default, int trafficProportion = default, StateEnum? state = default, bool reviewRequired = default, DateTimeOffset startDate = default, DateTimeOffset endDate = default)
        {
            this.Name = name;
