...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public SubscriptionUpdateRequestDataAttributes(string name = default, bool? familySharable = default, SubscriptionPeriodEnum? subscriptionPeriod = default, string reviewNote = default, int? groupLevel = default)
        {
            this.Name = name;
