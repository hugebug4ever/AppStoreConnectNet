...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ScmPullRequest : IValidatableObject
    {
        ...
        public ScmPullRequest(TypeEnum type = default, string id = default, ScmPullRequestAttributes attributes = default, ScmGitReferenceRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
