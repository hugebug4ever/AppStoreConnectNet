...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaTesterAttributes : IValidatableObject
    {
        ...
        /// <param name="appDevices">appDevices.</param>
        public BetaTesterAttributes(string firstName = default, string lastName = default, string email = default, BetaInviteType? inviteType = default, BetaTesterState? state = default, List<BetaTesterAttributesAppDevicesInner> appDevices = default)
        {
        ...
        /// <summary>
        /// Gets or Sets AppDevices
        /// </summary>
        [DataMember(Name = "appDevices", EmitDefaultValue = false)]
        public List<BetaTesterAttributesAppDevicesInner> AppDevices { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AppDevices: ").Append(AppDevices).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
