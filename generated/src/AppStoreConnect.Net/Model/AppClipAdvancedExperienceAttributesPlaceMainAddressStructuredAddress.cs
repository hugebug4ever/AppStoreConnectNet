...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppClipAdvancedExperienceAttributesPlaceMainAddressStructuredAddress : IValidatableObject
    {
        ...
        public AppClipAdvancedExperienceAttributesPlaceMainAddressStructuredAddress(List<string> streetAddress = default, string floor = default, string neighborhood = default, string locality = default, string stateProvince = default, string postalCode = default, string countryCode = default)
        {
