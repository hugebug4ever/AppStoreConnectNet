...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ActorAttributes : IValidatableObject
    {
        ...
        public ActorAttributes(ActorTypeEnum? actorType = default, string userFirstName = default, string userLastName = default, string userEmail = default, string apiKeyId = default)
        {
