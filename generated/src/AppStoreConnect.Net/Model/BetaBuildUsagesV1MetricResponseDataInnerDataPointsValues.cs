...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaBuildUsagesV1MetricResponseDataInnerDataPointsValues : IValidatableObject
    {
        ...
        public BetaBuildUsagesV1MetricResponseDataInnerDataPointsValues(int crashCount = default, int installCount = default, int sessionCount = default, int feedbackCount = default, int inviteCount = default)
        {
