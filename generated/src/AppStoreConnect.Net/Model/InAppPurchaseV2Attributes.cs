...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class InAppPurchaseV2Attributes : IValidatableObject
    {
        ...
        public InAppPurchaseV2Attributes(string name = default, string productId = default, InAppPurchaseType? inAppPurchaseType = default, InAppPurchaseState? state = default, string reviewNote = default, bool familySharable = default, bool contentHosting = default)
        {
            this.Name = name;
