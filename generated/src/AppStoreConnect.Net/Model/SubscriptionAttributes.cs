...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionAttributes : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        public SubscriptionAttributes(string name = default, string productId = default, bool familySharable = default, StateEnum? state = default, SubscriptionPeriodEnum? subscriptionPeriod = default, string reviewNote = default, int groupLevel = default)
        {
            this.Name = name;
