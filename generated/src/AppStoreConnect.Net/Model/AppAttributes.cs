...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppAttributes : IValidatableObject
    {
        ...
        public AppAttributes(string accessibilityUrl = default, string name = default, string bundleId = default, string sku = default, string primaryLocale = default, bool isOrEverWasMadeForKids = default, string subscriptionStatusUrl = default, SubscriptionStatusUrlVersion? subscriptionStatusUrlVersion = default, string subscriptionStatusUrlForSandbox = default, SubscriptionStatusUrlVersion? subscriptionStatusUrlVersionForSandbox = default, ContentRightsDeclarationEnum? contentRightsDeclaration = default, bool streamlinedPurchasingEnabled = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "accessibilityUrl", EmitDefaultValue = false)]
