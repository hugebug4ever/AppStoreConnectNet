...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionLocalizationCreateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreVersionLocalizationCreateRequestDataAttributes(string description = default, string locale = default, string keywords = default, string marketingUrl = default, string promotionalText = default, string supportUrl = default, string whatsNew = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "marketingUrl", EmitDefaultValue = true)]
        public string MarketingUrl { get; set; }

        /// <summary>
        /// Gets or Sets PromotionalText
        /// </summary>
        [DataMember(Name = "promotionalText", EmitDefaultValue = true)]
        public string PromotionalText { get; set; }

        /// <summary>
        /// Gets or Sets SupportUrl
        /// </summary>
        [DataMember(Name = "supportUrl", EmitDefaultValue = true)]
        public string SupportUrl { get; set; }

        /// <summary>
        /// Gets or Sets WhatsNew
        /// </summary>
        [DataMember(Name = "whatsNew", EmitDefaultValue = true)]
