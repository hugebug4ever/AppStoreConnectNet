...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionRelationships : IValidatableObject
    {
        ...
        public SubscriptionRelationships(SubscriptionRelationshipsSubscriptionLocalizations subscriptionLocalizations = default, SubscriptionRelationshipsAppStoreReviewScreenshot appStoreReviewScreenshot = default, SubscriptionGroupLocalizationRelationshipsSubscriptionGroup group = default, SubscriptionRelationshipsIntroductoryOffers introductoryOffers = default, SubscriptionRelationshipsPromotionalOffers promotionalOffers = default, SubscriptionRelationshipsOfferCodes offerCodes = default, SubscriptionRelationshipsPrices prices = default, AnalyticsReportInstanceRelationshipsSegments pricePoints = default, InAppPurchaseV2RelationshipsPromotedPurchase promotedPurchase = default, SubscriptionRelationshipsSubscriptionAvailability subscriptionAvailability = default, SubscriptionRelationshipsWinBackOffers winBackOffers = default, SubscriptionRelationshipsImages images = default)
        {
