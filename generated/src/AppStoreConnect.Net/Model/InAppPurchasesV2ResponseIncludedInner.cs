...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class InAppPurchasesV2ResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InAppPurchasesV2ResponseIncludedInner" /> class
        /// with the <see cref="InAppPurchaseAvailability" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of InAppPurchaseAvailability.</param>
        public InAppPurchasesV2ResponseIncludedInner(InAppPurchaseAvailability actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InAppPurchasesV2ResponseIncludedInner" /> class
        /// with the <see cref="InAppPurchaseImage" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of InAppPurchaseImage.</param>
        public InAppPurchasesV2ResponseIncludedInner(InAppPurchaseImage actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InAppPurchasesV2ResponseIncludedInner" /> class
        /// with the <see cref="InAppPurchaseOfferCode" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of InAppPurchaseOfferCode.</param>
        public InAppPurchasesV2ResponseIncludedInner(InAppPurchaseOfferCode actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(InAppPurchaseAppStoreReviewScreenshot) || value is InAppPurchaseAppStoreReviewScreenshot)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchaseAvailability) || value is InAppPurchaseAvailability)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchaseContent) || value is InAppPurchaseContent)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchaseImage) || value is InAppPurchaseImage)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchaseLocalization) || value is InAppPurchaseLocalization)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchaseOfferCode) || value is InAppPurchaseOfferCode)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchasePricePoint) || value is InAppPurchasePricePoint)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(InAppPurchasePriceSchedule) || value is InAppPurchasePriceSchedule)
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: InAppPurchaseAppStoreReviewScreenshot, InAppPurchaseAvailability, InAppPurchaseContent, InAppPurchaseImage, InAppPurchaseLocalization, InAppPurchaseOfferCode, InAppPurchasePricePoint, InAppPurchasePriceSchedule, PromotedPurchase");
                }
            }
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of InAppPurchaseAvailability</returns>
        public InAppPurchaseAvailability GetInAppPurchaseAvailability()
        {
            return (InAppPurchaseAvailability)this.ActualInstance;
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of InAppPurchaseImage</returns>
        public InAppPurchaseImage GetInAppPurchaseImage()
        {
            return (InAppPurchaseImage)this.ActualInstance;
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of InAppPurchaseOfferCode</returns>
        public InAppPurchaseOfferCode GetInAppPurchaseOfferCode()
        {
            return (InAppPurchaseOfferCode)this.ActualInstance;
        }
        ...
        public static InAppPurchasesV2ResponseIncludedInner FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(InAppPurchaseAvailability).GetProperty("AdditionalProperties") == null)
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseAvailability>(jsonString, InAppPurchasesV2ResponseIncludedInner.SerializerSettings));
                }
                else
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseAvailability>(jsonString, InAppPurchasesV2ResponseIncludedInner.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("InAppPurchaseAvailability");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into InAppPurchaseAvailability: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(InAppPurchaseImage).GetProperty("AdditionalProperties") == null)
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseImage>(jsonString, InAppPurchasesV2ResponseIncludedInner.SerializerSettings));
                }
                else
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseImage>(jsonString, InAppPurchasesV2ResponseIncludedInner.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("InAppPurchaseImage");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into InAppPurchaseImage: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(InAppPurchaseOfferCode).GetProperty("AdditionalProperties") == null)
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseOfferCode>(jsonString, InAppPurchasesV2ResponseIncludedInner.SerializerSettings));
                }
                else
                {
                    newInAppPurchasesV2ResponseIncludedInner = new InAppPurchasesV2ResponseIncludedInner(JsonConvert.DeserializeObject<InAppPurchaseOfferCode>(jsonString, InAppPurchasesV2ResponseIncludedInner.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("InAppPurchaseOfferCode");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into InAppPurchaseOfferCode: {1}", jsonString, exception.ToString()));
            }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return InAppPurchasesV2ResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
