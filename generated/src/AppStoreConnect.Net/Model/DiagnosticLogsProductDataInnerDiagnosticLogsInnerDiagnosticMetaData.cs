...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class DiagnosticLogsProductDataInnerDiagnosticLogsInnerDiagnosticMetaData : IValidatableObject
    {
        ...
        public DiagnosticLogsProductDataInnerDiagnosticLogsInnerDiagnosticMetaData(string bundleId = default, string varEvent = default, string osVersion = default, string appVersion = default, string writesCaused = default, string deviceType = default, string platformArchitecture = default, string eventDetail = default, string buildVersion = default)
        {
