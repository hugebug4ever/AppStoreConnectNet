...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class WinBackOfferUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public WinBackOfferUpdateRequestDataAttributes(int? customerEligibilityPaidSubscriptionDurationInMonths = default, IntegerRange customerEligibilityTimeSinceLastSubscribedInMonths = default, int? customerEligibilityWaitBetweenOffersInMonths = default, DateOnly? startDate = default, DateOnly? endDate = default, PriorityEnum? priority = default, PromotionIntentEnum? promotionIntent = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "customerEligibilityPaidSubscriptionDurationInMonths", EmitDefaultValue = true)]
