...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaAppLocalizationAttributes : IValidatableObject
    {
        ...
        public BetaAppLocalizationAttributes(string feedbackEmail = default, string marketingUrl = default, string privacyPolicyUrl = default, string tvOsPrivacyPolicy = default, string description = default, string locale = default)
        {
