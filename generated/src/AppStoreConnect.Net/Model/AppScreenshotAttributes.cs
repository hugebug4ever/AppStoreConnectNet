...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppScreenshotAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppScreenshotAttributes(int fileSize = default, string fileName = default, string sourceFileChecksum = default, ImageAsset imageAsset = default, string assetToken = default, string assetType = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default)
        {
