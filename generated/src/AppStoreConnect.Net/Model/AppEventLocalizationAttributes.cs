...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventLocalizationAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppEventLocalizationAttributes(string locale = default, string name = default, string shortDescription = default, string longDescription = default)
        {
            this.Locale = locale;
            this.Name = name;
