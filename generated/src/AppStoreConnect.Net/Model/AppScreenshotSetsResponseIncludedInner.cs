...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppScreenshotSetsResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(AppCustomProductPageLocalization) || value is AppCustomProductPageLocalization)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(AppScreenshot) || value is AppScreenshot)
                {
                    this._actualInstance = value;
                }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return AppScreenshotSetsResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
