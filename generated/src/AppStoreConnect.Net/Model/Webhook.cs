...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class Webhook : IValidatableObject
    {
        ...
        public Webhook(TypeEnum type = default, string id = default, WebhookAttributes attributes = default, WebhookRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
