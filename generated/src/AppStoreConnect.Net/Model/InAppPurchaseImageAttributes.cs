...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class InAppPurchaseImageAttributes : IValidatableObject
    {
        ...
        public InAppPurchaseImageAttributes(int fileSize = default, string fileName = default, string sourceFileChecksum = default, string assetToken = default, ImageAsset imageAsset = default, List<UploadOperation> uploadOperations = default, StateEnum? state = default)
        {
