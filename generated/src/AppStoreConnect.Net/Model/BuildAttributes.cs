...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BuildAttributes : IValidatableObject
    {
        ...
        /// <param name="computedMinVisionOsVersion">computedMinVisionOsVersion.</param>
        ...
        public BuildAttributes(string varVersion = default, DateTimeOffset uploadedDate = default, DateTimeOffset expirationDate = default, bool expired = default, string minOsVersion = default, string lsMinimumSystemVersion = default, string computedMinMacOsVersion = default, string computedMinVisionOsVersion = default, ImageAsset iconAssetToken = default, ProcessingStateEnum? processingState = default, BuildAudienceType? buildAudienceType = default, bool usesNonExemptEncryption = default)
        {
        ...
        /// <summary>
        /// Gets or Sets ComputedMinVisionOsVersion
        /// </summary>
        [DataMember(Name = "computedMinVisionOsVersion", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ComputedMinVisionOsVersion: ").Append(ComputedMinVisionOsVersion).Append("\n");
