...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEncryptionDeclarationDocumentAttributes : IValidatableObject
    {
        ...
        public AppEncryptionDeclarationDocumentAttributes(int fileSize = default, string fileName = default, string assetToken = default, string downloadUrl = default, string sourceFileChecksum = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default)
        {
