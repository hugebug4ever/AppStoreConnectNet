...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiXcodeVersionAttributesTestDestinationsInner : IValidatableObject
    {
        ...
        public CiXcodeVersionAttributesTestDestinationsInner(string deviceTypeName = default, string deviceTypeIdentifier = default, List<CiXcodeVersionAttributesTestDestinationsInnerAvailableRuntimesInner> availableRuntimes = default, CiTestDestinationKind? kind = default)
        {
