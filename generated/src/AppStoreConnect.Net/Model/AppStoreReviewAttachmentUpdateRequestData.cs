...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreReviewAttachmentUpdateRequestData : IValidatableObject
    {
        ...
        public AppStoreReviewAttachmentUpdateRequestData(TypeEnum type = default, string id = default, AppClipAdvancedExperienceImageUpdateRequestDataAttributes attributes = default)
        {
            this.Type = type;
