...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventAttributes : IValidatableObject
    {
        ...
        public AppEventAttributes(string referenceName = default, BadgeEnum? badge = default, EventStateEnum? eventState = default, string deepLink = default, string purchaseRequirement = default, string primaryLocale = default, PriorityEnum? priority = default, PurposeEnum? purpose = default, List<AppEventAttributesTerritorySchedulesInner> territorySchedules = default, List<AppEventAttributesTerritorySchedulesInner> archivedTerritorySchedules = default)
        {
