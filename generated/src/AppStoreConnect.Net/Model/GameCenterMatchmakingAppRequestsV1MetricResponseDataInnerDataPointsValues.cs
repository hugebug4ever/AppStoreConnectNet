...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPointsValues : IValidatableObject
    {
        ...
        public GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPointsValues(int count = default, decimal averageSecondsInQueue = default, decimal p50SecondsInQueue = default, decimal p95SecondsInQueue = default)
        {
            this.Count = count;
