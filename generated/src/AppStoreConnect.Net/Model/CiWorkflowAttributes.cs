...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiWorkflowAttributes : IValidatableObject
    {
        ...
        public CiWorkflowAttributes(string name = default, string description = default, CiBranchStartCondition branchStartCondition = default, CiTagStartCondition tagStartCondition = default, CiPullRequestStartCondition pullRequestStartCondition = default, CiScheduledStartCondition scheduledStartCondition = default, CiManualBranchStartCondition manualBranchStartCondition = default, CiManualTagStartCondition manualTagStartCondition = default, CiManualPullRequestStartCondition manualPullRequestStartCondition = default, List<CiAction> actions = default, bool isEnabled = default, bool isLockedForEditing = default, bool clean = default, string containerFilePath = default, DateTimeOffset lastModifiedDate = default)
        {
            this.Name = name;
