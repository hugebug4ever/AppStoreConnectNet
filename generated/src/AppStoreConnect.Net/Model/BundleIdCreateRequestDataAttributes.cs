...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BundleIdCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public BundleIdCreateRequestDataAttributes(string name = default, BundleIdPlatform platform = default, string identifier = default, string seedId = default)
        {
        ...
        /// Gets or Sets SeedId
        /// </summary>
        [DataMember(Name = "seedId", EmitDefaultValue = true)]
