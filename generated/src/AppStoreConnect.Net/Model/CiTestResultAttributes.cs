...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiTestResultAttributes : IValidatableObject
    {
        ...
        public CiTestResultAttributes(string className = default, string name = default, CiTestStatus? status = default, FileLocation fileSource = default, string message = default, List<CiTestResultAttributesDestinationTestResultsInner> destinationTestResults = default)
        {
