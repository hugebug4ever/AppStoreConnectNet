...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingRuleSetAttributes : IValidatableObject
    {
        ...
        public GameCenterMatchmakingRuleSetAttributes(string referenceName = default, int ruleLanguageVersion = default, int minPlayers = default, int maxPlayers = default)
        {
