...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventLocalizationUpdateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppEventLocalizationUpdateRequestDataAttributes(string name = default, string shortDescription = default, string longDescription = default)
        {
            this.Name = name;
