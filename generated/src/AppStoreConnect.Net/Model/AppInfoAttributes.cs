...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppInfoAttributes : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "franceAgeRating", EmitDefaultValue = false)]
        [Obsolete]
        public FranceAgeRatingEnum? FranceAgeRating { get; set; }
        /// <summary>
        ...
        /// <param name="franceAgeRating">franceAgeRating.</param>
        /// <param name="koreaAgeRating">koreaAgeRating.</param>
        /// <param name="kidsAgeBand">kidsAgeBand.</param>
        public AppInfoAttributes(AppStoreVersionState? appStoreState = default, StateEnum? state = default, AppStoreAgeRating? appStoreAgeRating = default, AustraliaAgeRatingEnum? australiaAgeRating = default, BrazilAgeRating? brazilAgeRating = default, BrazilAgeRatingV2Enum? brazilAgeRatingV2 = default, FranceAgeRatingEnum? franceAgeRating = default, KoreaAgeRatingEnum? koreaAgeRating = default, KidsAgeBand? kidsAgeBand = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FranceAgeRating: ").Append(FranceAgeRating).Append("\n");
