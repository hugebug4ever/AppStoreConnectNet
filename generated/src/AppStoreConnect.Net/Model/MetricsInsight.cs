...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class MetricsInsight : IValidatableObject
    {
        ...
        public MetricsInsight(MetricCategory? metricCategory = default, string latestVersion = default, string metric = default, string summaryString = default, string referenceVersions = default, decimal maxLatestVersionValue = default, string subSystemLabel = default, bool highImpact = default, List<MetricsInsightPopulationsInner> populations = default)
        {
