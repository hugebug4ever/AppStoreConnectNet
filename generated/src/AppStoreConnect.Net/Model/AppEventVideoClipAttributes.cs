...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventVideoClipAttributes : IValidatableObject
    {
        ...
        public AppEventVideoClipAttributes(int fileSize = default, string fileName = default, string previewFrameTimeCode = default, string videoUrl = default, PreviewFrameImage previewFrameImage = default, ImageAsset previewImage = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default, AppMediaVideoState videoDeliveryState = default, AppEventAssetType? appEventAssetType = default)
        {
