...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionExperimentTreatment : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public AppStoreVersionExperimentTreatment(TypeEnum type = default, string id = default, AppStoreVersionExperimentTreatmentAttributes attributes = default, AppStoreVersionExperimentTreatmentRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
