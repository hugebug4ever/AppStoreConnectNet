...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionPromotionalOffersResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(SubscriptionPromotionalOfferPrice) || value is SubscriptionPromotionalOfferPrice)
                {
                    this._actualInstance = value;
                }
                else
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return SubscriptionPromotionalOffersResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
