...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionCreateRequest : IValidatableObject
    {
        ...
        public SubscriptionCreateRequest(SubscriptionCreateRequestData data = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for SubscriptionCreateRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public SubscriptionCreateRequestData Data { get; set; }
