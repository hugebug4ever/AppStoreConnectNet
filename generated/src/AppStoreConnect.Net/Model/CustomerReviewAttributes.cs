...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CustomerReviewAttributes : IValidatableObject
    {
        ...
        public CustomerReviewAttributes(int rating = default, string title = default, string body = default, string reviewerNickname = default, DateTimeOffset createdDate = default, TerritoryCode? territory = default)
        {
            this.Rating = rating;
            this.Title = title;
            this.Body = body;
