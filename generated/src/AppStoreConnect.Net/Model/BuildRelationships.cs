...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BuildRelationships : IValidatableObject
    {
        ...
        /// <param name="buildUpload">buildUpload.</param>
        /// <param name="perfPowerMetrics">perfPowerMetrics.</param>
        /// <param name="diagnosticSignatures">diagnosticSignatures.</param>
        public BuildRelationships(BuildRelationshipsPreReleaseVersion preReleaseVersion = default, BetaGroupRelationshipsBetaTesters individualTesters = default, AppRelationshipsBetaGroups betaGroups = default, BuildRelationshipsBetaBuildLocalizations betaBuildLocalizations = default, BuildRelationshipsAppEncryptionDeclaration appEncryptionDeclaration = default, BuildRelationshipsBetaAppReviewSubmission betaAppReviewSubmission = default, BetaAppLocalizationRelationshipsApp app = default, BuildRelationshipsBuildBetaDetail buildBetaDetail = default, AppClipDefaultExperienceRelationshipsReleaseWithAppStoreVersion appStoreVersion = default, BuildRelationshipsIcons icons = default, BuildRelationshipsBuildBundles buildBundles = default, BuildRelationshipsBuildUpload buildUpload = default, AnalyticsReportInstanceRelationshipsSegments perfPowerMetrics = default, AnalyticsReportInstanceRelationshipsSegments diagnosticSignatures = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "buildUpload", EmitDefaultValue = false)]
        public BuildRelationshipsBuildUpload BuildUpload { get; set; }
