...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEventVideoClipCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public AppEventVideoClipCreateRequestDataAttributes(int fileSize = default, string fileName = default, string previewFrameTimeCode = default, AppEventAssetType appEventAssetType = default)
        {
