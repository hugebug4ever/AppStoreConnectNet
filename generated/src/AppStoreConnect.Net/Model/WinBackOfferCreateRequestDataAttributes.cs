...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class WinBackOfferCreateRequestDataAttributes : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "promotionIntent", EmitDefaultValue = true)]
        ...
        public WinBackOfferCreateRequestDataAttributes(string referenceName = default, string offerId = default, SubscriptionOfferDuration duration = default, SubscriptionOfferMode offerMode = default, int periodCount = default, int customerEligibilityPaidSubscriptionDurationInMonths = default, IntegerRange customerEligibilityTimeSinceLastSubscribedInMonths = default, int? customerEligibilityWaitBetweenOffersInMonths = default, DateOnly startDate = default, DateOnly? endDate = default, PriorityEnum priority = default, PromotionIntentEnum? promotionIntent = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "customerEligibilityWaitBetweenOffersInMonths", EmitDefaultValue = true)]
