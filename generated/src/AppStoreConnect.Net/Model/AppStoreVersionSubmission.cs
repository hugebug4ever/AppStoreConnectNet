...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionSubmission : IValidatableObject
    {
        ...
        public AppStoreVersionSubmission(TypeEnum type = default, string id = default, AppStoreVersionSubmissionRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
