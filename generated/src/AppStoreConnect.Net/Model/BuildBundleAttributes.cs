...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BuildBundleAttributes : IValidatableObject
    {
        ...
        public BuildBundleType? BundleType { get; set; }
        /// <summary>
        ...
        /// <param name="baDownloadAllowance">baDownloadAllowance.</param>
        /// <param name="baMaxInstallSize">baMaxInstallSize.</param>
        public BuildBundleAttributes(string bundleId = default, BuildBundleType? bundleType = default, string sdkBuild = default, string platformBuild = default, string fileName = default, bool hasSirikit = default, bool hasOnDemandResources = default, bool hasPrerenderedIcon = default, bool usesLocationServices = default, bool isIosBuildMacAppStoreCompatible = default, bool includesSymbols = default, string dSYMUrl = default, List<string> supportedArchitectures = default, List<string> requiredCapabilities = default, List<string> deviceProtocols = default, List<string> locales = default, Dictionary<string, Dictionary<string, string>> entitlements = default, int baDownloadAllowance = default, int baMaxInstallSize = default)
        {
        ...
        /// <summary>
        /// Gets or Sets BaDownloadAllowance
        /// </summary>
        [DataMember(Name = "baDownloadAllowance", EmitDefaultValue = false)]
        public int BaDownloadAllowance { get; set; }

        /// <summary>
        /// Gets or Sets BaMaxInstallSize
        /// </summary>
        [DataMember(Name = "baMaxInstallSize", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BaDownloadAllowance: ").Append(BaDownloadAllowance).Append("\n");
            sb.Append("  BaMaxInstallSize: ").Append(BaMaxInstallSize).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
