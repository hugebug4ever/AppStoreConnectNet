...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class DeviceAttributes : IValidatableObject
    {
        ...
        public DeviceAttributes(string name = default, BundleIdPlatform? platform = default, string udid = default, DeviceClassEnum? deviceClass = default, StatusEnum? status = default, string model = default, DateTimeOffset addedDate = default)
        {
            this.Name = name;
