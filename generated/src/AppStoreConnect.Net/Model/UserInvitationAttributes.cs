...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class UserInvitationAttributes : IValidatableObject
    {
        ...
        public UserInvitationAttributes(string email = default, string firstName = default, string lastName = default, DateTimeOffset expirationDate = default, List<UserRole> roles = default, bool allAppsVisible = default, bool provisioningAllowed = default)
        {
            this.Email = email;
