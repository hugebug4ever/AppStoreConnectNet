...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiBuildRunsResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(CiWorkflow) || value is CiWorkflow)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ScmGitReference) || value is ScmGitReference)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ScmPullRequest) || value is ScmPullRequest)
                {
                    this._actualInstance = value;
                }
                else
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return CiBuildRunsResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
