...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class WebhookUpdateRequest : IValidatableObject
    {
        ...
        public WebhookUpdateRequest(WebhookUpdateRequestData data = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for WebhookUpdateRequest and cannot be null");
            }
            this.Data = data;
        }
        ...
        public WebhookUpdateRequestData Data { get; set; }
