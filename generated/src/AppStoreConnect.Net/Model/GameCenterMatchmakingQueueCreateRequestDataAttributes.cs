...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameCenterMatchmakingQueueCreateRequest_data_attributes")]
    public partial class GameCenterMatchmakingQueueCreateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GameCenterMatchmakingQueueCreateRequestDataAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GameCenterMatchmakingQueueCreateRequestDataAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GameCenterMatchmakingQueueCreateRequestDataAttributes" /> class.
        /// </summary>
        ...
        public GameCenterMatchmakingQueueCreateRequestDataAttributes(string referenceName = default, List<string> classicMatchmakingBundleIds = default)
        {
            // to ensure "referenceName" is required (not null)
            if (referenceName == null)
            {
                throw new ArgumentNullException("referenceName is a required property for GameCenterMatchmakingQueueCreateRequestDataAttributes and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "classicMatchmakingBundleIds", EmitDefaultValue = true)]
