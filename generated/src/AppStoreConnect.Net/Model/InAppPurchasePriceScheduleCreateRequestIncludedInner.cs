...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class InAppPurchasePriceScheduleCreateRequestIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(InAppPurchasePriceInlineCreate) || value is InAppPurchasePriceInlineCreate)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(TerritoryInlineCreate) || value is TerritoryInlineCreate)
                {
                    this._actualInstance = value;
                }
                else
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return InAppPurchasePriceScheduleCreateRequestIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
