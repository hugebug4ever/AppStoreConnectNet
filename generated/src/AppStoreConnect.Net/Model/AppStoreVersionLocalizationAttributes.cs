...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionLocalizationAttributes : IValidatableObject
    {
        ...
        public AppStoreVersionLocalizationAttributes(string description = default, string locale = default, string keywords = default, string marketingUrl = default, string promotionalText = default, string supportUrl = default, string whatsNew = default)
        {
