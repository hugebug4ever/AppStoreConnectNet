...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionIntroductoryOfferRelationshipsSubscriptionPricePoint : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionIntroductoryOfferRelationshipsSubscriptionPricePoint" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SubscriptionIntroductoryOfferRelationshipsSubscriptionPricePoint(SubscriptionIntroductoryOfferRelationshipsSubscriptionPricePointData data = default)
        {
            this.Data = data;
        }
