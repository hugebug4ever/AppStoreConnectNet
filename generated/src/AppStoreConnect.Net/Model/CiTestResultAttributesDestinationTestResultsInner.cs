...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiTestResultAttributesDestinationTestResultsInner : IValidatableObject
    {
        ...
        public CiTestResultAttributesDestinationTestResultsInner(string uuid = default, string deviceName = default, string osVersion = default, CiTestStatus? status = default, decimal duration = default)
        {
            this.Uuid = uuid;
