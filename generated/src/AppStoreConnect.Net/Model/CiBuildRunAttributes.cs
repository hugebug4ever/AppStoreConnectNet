...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiBuildRunAttributes : IValidatableObject
    {
        ...
        public CiBuildRunAttributes(int number = default, DateTimeOffset createdDate = default, DateTimeOffset startedDate = default, DateTimeOffset finishedDate = default, CiBuildRunAttributesSourceCommit sourceCommit = default, CiBuildRunAttributesSourceCommit destinationCommit = default, bool isPullRequestBuild = default, CiIssueCounts issueCounts = default, CiExecutionProgress? executionProgress = default, CiCompletionStatus? completionStatus = default, StartReasonEnum? startReason = default, CancelReasonEnum? cancelReason = default)
        {
            this.Number = number;
