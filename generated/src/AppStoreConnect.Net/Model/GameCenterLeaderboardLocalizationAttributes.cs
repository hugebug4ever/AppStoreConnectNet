...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameCenterLeaderboardLocalization_attributes")]
    public partial class GameCenterLeaderboardLocalizationAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardLocalizationAttributes(string locale = default, string name = default, GameCenterLeaderboardFormatter? formatterOverride = default, string formatterSuffix = default, string formatterSuffixSingular = default, string description = default)
        {
            this.Locale = locale;
            this.Name = name;
