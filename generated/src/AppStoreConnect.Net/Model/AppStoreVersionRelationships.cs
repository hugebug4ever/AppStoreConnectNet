...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionRelationships : IValidatableObject
    {
        ...
        public AppStoreVersionRelationships(AlternativeDistributionKeyCreateRequestDataRelationshipsApp app = default, AppStoreVersionRelationshipsAgeRatingDeclaration ageRatingDeclaration = default, AppStoreVersionRelationshipsAppStoreVersionLocalizations appStoreVersionLocalizations = default, AppStoreVersionRelationshipsBuild build = default, AppStoreVersionRelationshipsAppStoreVersionPhasedRelease appStoreVersionPhasedRelease = default, AppStoreVersionRelationshipsGameCenterAppVersion gameCenterAppVersion = default, AppStoreVersionRelationshipsRoutingAppCoverage routingAppCoverage = default, AppStoreVersionRelationshipsAppStoreReviewDetail appStoreReviewDetail = default, AppStoreVersionRelationshipsAppStoreVersionSubmission appStoreVersionSubmission = default, AppStoreVersionRelationshipsAppClipDefaultExperience appClipDefaultExperience = default, AppStoreVersionRelationshipsAppStoreVersionExperiments appStoreVersionExperiments = default, AppStoreVersionRelationshipsAppStoreVersionExperiments appStoreVersionExperimentsV2 = default, AnalyticsReportInstanceRelationshipsSegments customerReviews = default, AppStoreVersionRelationshipsAlternativeDistributionPackage alternativeDistributionPackage = default)
        {
            this.App = app;
