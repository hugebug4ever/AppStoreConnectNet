...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="recommendedMetricGoal">recommendedMetricGoal.</param>
        public XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInner(XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerFilterCriteria filterCriteria = default, List<XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerPointsInner> points = default, XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerRecommendedMetricGoal recommendedMetricGoal = default)
        {
        ...
        /// <summary>
        /// Gets or Sets RecommendedMetricGoal
        /// </summary>
        [DataMember(Name = "recommendedMetricGoal", EmitDefaultValue = false)]
        public XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerRecommendedMetricGoal RecommendedMetricGoal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecommendedMetricGoal: ").Append(RecommendedMetricGoal).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
