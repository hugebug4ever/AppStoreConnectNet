...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppsResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        /// with the <see cref="AndroidToIosAppMappingDetail" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of AndroidToIosAppMappingDetail.</param>
        public AppsResponseIncludedInner(AndroidToIosAppMappingDetail actualInstance)
        {
        ...
        public AppsResponseIncludedInner(BuildIcon actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(AndroidToIosAppMappingDetail) || value is AndroidToIosAppMappingDetail)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(AppClip) || value is AppClip)
                {
                    this._actualInstance = value;
                }
                ...
                else if (value.GetType() == typeof(BuildIcon) || value is BuildIcon)
                {
                    this._actualInstance = value;
                }
        ...
        /// </summary>
        /// <returns>An instance of AndroidToIosAppMappingDetail</returns>
        public AndroidToIosAppMappingDetail GetAndroidToIosAppMappingDetail()
        {
            return (AndroidToIosAppMappingDetail)this.ActualInstance;
        }
        ...
        public static AppsResponseIncludedInner FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                if (typeof(AndroidToIosAppMappingDetail).GetProperty("AdditionalProperties") == null)
                {
                    newAppsResponseIncludedInner = new AppsResponseIncludedInner(JsonConvert.DeserializeObject<AndroidToIosAppMappingDetail>(jsonString, AppsResponseIncludedInner.SerializerSettings));
                }
                else
                {
                    newAppsResponseIncludedInner = new AppsResponseIncludedInner(JsonConvert.DeserializeObject<AndroidToIosAppMappingDetail>(jsonString, AppsResponseIncludedInner.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("AndroidToIosAppMappingDetail");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into AndroidToIosAppMappingDetail: {1}", jsonString, exception.ToString()));
            }
            ...
            try
            {
                ...
                {
                    newAppsResponseIncludedInner = new AppsResponseIncludedInner(JsonConvert.DeserializeObject<BuildIcon>(jsonString, AppsResponseIncludedInner.SerializerSettings));
                }
                else
                {
                    newAppsResponseIncludedInner = new AppsResponseIncludedInner(JsonConvert.DeserializeObject<BuildIcon>(jsonString, AppsResponseIncludedInner.AdditionalPropertiesSerializerSettings));
                }
