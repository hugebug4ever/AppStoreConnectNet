...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppClipAdvancedExperienceAttributesPlace : IValidatableObject
    {
        /// <summary>
        /// Defines MapAction
        /// </summary>
        ...
        public AppClipAdvancedExperienceAttributesPlace(string placeId = default, List<string> names = default, AppClipAdvancedExperienceAttributesPlaceMainAddress mainAddress = default, AppClipAdvancedExperienceAttributesPlaceDisplayPoint displayPoint = default, MapActionEnum? mapAction = default, RelationshipEnum? relationship = default, AppClipAdvancedExperienceAttributesPlacePhoneNumber phoneNumber = default, string homePage = default, List<string> categories = default)
        {
