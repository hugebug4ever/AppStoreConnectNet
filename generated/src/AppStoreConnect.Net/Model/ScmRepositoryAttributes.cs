...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ScmRepositoryAttributes : IValidatableObject
    {
        ...
        public ScmRepositoryAttributes(DateTimeOffset lastAccessedDate = default, string httpCloneUrl = default, string sshCloneUrl = default, string ownerName = default, string repositoryName = default)
        {
