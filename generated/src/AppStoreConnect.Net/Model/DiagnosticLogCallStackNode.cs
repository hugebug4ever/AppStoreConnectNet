...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class DiagnosticLogCallStackNode : IValidatableObject
    {
        /// <summary>
        ...
        public DiagnosticLogCallStackNode(int sampleCount = default, bool isBlameFrame = default, string symbolName = default, string insightsCategory = default, string offsetIntoSymbol = default, string binaryName = default, string fileName = default, string binaryUUID = default, string lineNumber = default, string address = default, string offsetIntoBinaryTextSegment = default, string rawFrame = default, List<DiagnosticLogCallStackNode> subFrames = default)
        {
