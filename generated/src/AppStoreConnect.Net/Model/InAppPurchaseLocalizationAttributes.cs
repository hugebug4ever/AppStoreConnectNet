...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InAppPurchaseLocalization_attributes")]
    public partial class InAppPurchaseLocalizationAttributes : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        public InAppPurchaseLocalizationAttributes(string name = default, string locale = default, string description = default, StateEnum? state = default)
        {
            this.Name = name;
            this.Locale = locale;
