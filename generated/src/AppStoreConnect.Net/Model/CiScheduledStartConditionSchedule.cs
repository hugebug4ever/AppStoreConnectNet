...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiScheduledStartConditionSchedule : IValidatableObject
    {
        ...
        public CiScheduledStartConditionSchedule(FrequencyEnum? frequency = default, List<DaysEnum> days = default, int hour = default, int minute = default, string timezone = default)
        {
