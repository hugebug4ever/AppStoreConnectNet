...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionLocalizationUpdateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public AppStoreVersionLocalizationUpdateRequestDataAttributes(string description = default, string keywords = default, string marketingUrl = default, string promotionalText = default, string supportUrl = default, string whatsNew = default)
        {
