...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionExperimentTreatmentAttributes : IValidatableObject
    {
        ...
        public AppStoreVersionExperimentTreatmentAttributes(string name = default, ImageAsset appIcon = default, string appIconName = default, DateTimeOffset promotedDate = default)
        {
            this.Name = name;
