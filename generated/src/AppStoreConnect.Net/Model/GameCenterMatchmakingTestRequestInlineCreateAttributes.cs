...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingTestRequestInlineCreateAttributes : IValidatableObject
    {
        ...
        public GameCenterMatchmakingTestRequestInlineCreateAttributes(string requestName = default, int secondsInQueue = default, LocaleEnum? locale = default, Location location = default, int? minPlayers = default, int? maxPlayers = default, int? playerCount = default, string bundleId = default, Platform platform = default, string appVersion = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "minPlayers", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "playerCount", EmitDefaultValue = true)]
