...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CertificateAttributes : IValidatableObject
    {
        ...
        public CertificateAttributes(string name = default, CertificateType? certificateType = default, string displayName = default, string serialNumber = default, BundleIdPlatform? platform = default, DateTimeOffset expirationDate = default, string certificateContent = default, bool activated = default)
        {
            this.Name = name;
