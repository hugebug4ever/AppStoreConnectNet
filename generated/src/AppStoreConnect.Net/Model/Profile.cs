...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class Profile : IValidatableObject
    {
        ...
        public Profile(TypeEnum type = default, string id = default, ProfileAttributes attributes = default, ProfileRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
