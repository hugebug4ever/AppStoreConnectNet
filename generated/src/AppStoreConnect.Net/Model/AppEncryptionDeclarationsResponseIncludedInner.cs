...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEncryptionDeclarationsResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(AppEncryptionDeclarationDocument) || value is AppEncryptionDeclarationDocument)
                {
                    this._actualInstance = value;
                }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return AppEncryptionDeclarationsResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
