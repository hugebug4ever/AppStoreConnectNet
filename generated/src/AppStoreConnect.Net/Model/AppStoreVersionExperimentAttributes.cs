...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionExperimentAttributes : IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        public AppStoreVersionExperimentAttributes(string name = default, int trafficProportion = default, StateEnum? state = default, bool reviewRequired = default, DateTimeOffset startDate = default, DateTimeOffset endDate = default)
        {
            this.Name = name;
