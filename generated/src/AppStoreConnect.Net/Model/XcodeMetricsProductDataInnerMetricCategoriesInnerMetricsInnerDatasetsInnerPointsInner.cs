...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerPointsInner : IValidatableObject
    {
        ...
        public XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerPointsInner(string varVersion = default, decimal value = default, decimal errorMargin = default, XcodeMetricsProductDataInnerMetricCategoriesInnerMetricsInnerDatasetsInnerPointsInnerPercentageBreakdown percentageBreakdown = default, string goal = default)
        {
