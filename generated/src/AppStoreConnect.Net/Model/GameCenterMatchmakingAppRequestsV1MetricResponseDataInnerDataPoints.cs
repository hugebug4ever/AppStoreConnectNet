...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPoints : IValidatableObject
    {
        ...
        public GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPoints(DateTimeOffset start = default, DateTimeOffset end = default, GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPointsValues values = default)
        {
            this.Start = start;
            this.End = end;
            this.Values = values;
