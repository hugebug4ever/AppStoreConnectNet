...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppEncryptionDeclarationAttributes : IValidatableObject
    {
        ...
        public AppEncryptionDeclarationAttributes(string appDescription = default, DateTimeOffset createdDate = default, bool usesEncryption = default, bool exempt = default, bool containsProprietaryCryptography = default, bool containsThirdPartyCryptography = default, bool availableOnFrenchStore = default, Platform? platform = default, DateTimeOffset uploadedDate = default, string documentUrl = default, string documentName = default, string documentType = default, AppEncryptionDeclarationState? appEncryptionDeclarationState = default, string codeValue = default)
        {
