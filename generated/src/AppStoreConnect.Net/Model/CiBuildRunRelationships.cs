...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiBuildRunRelationships : IValidatableObject
    {
        ...
        public CiBuildRunRelationships(AppRelationshipsBuilds builds = default, CiBuildRunRelationshipsWorkflow workflow = default, CiBuildRunRelationshipsProduct product = default, CiBuildRunRelationshipsSourceBranchOrTag sourceBranchOrTag = default, CiBuildRunRelationshipsSourceBranchOrTag destinationBranch = default, AnalyticsReportInstanceRelationshipsSegments actions = default, CiBuildRunRelationshipsPullRequest pullRequest = default)
        {
            this.Builds = builds;
