...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ScmPullRequestAttributes : IValidatableObject
    {
        ...
        public ScmPullRequestAttributes(string title = default, int number = default, string webUrl = default, string sourceRepositoryOwner = default, string sourceRepositoryName = default, string sourceBranchName = default, string destinationRepositoryOwner = default, string destinationRepositoryName = default, string destinationBranchName = default, bool isClosed = default, bool isCrossRepository = default)
        {
            this.Title = title;
            this.Number = number;
            this.WebUrl = webUrl;
