...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterAchievementImageAttributes : IValidatableObject
    {
        ...
        public GameCenterAchievementImageAttributes(int fileSize = default, string fileName = default, ImageAsset imageAsset = default, List<UploadOperation> uploadOperations = default, AppMediaAssetState assetDeliveryState = default)
        {
