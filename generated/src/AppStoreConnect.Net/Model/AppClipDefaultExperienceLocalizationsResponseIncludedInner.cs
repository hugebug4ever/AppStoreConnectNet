...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppClipDefaultExperienceLocalizationsResponseIncludedInner : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(AppClipDefaultExperience) || value is AppClipDefaultExperience)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(AppClipHeaderImage) || value is AppClipHeaderImage)
                {
                    this._actualInstance = value;
                }
                else
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return AppClipDefaultExperienceLocalizationsResponseIncludedInner.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
