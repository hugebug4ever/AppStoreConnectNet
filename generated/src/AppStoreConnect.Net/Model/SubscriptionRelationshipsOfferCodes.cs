...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionRelationshipsOfferCodes : IValidatableObject
    {
        ...
        public SubscriptionRelationshipsOfferCodes(RelationshipLinks links = default, PagingInformation meta = default, List<SubscriptionOfferCodeCustomCodeRelationshipsOfferCodeData> data = default)
        {
            this.Links = links;
            this.Meta = meta;
            this.Data = data;
