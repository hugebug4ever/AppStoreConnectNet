...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaGroupAttributes : IValidatableObject
    {
        ...
        /// <param name="iosBuildsAvailableForAppleVision">iosBuildsAvailableForAppleVision.</param>
        public BetaGroupAttributes(string name = default, DateTimeOffset createdDate = default, bool isInternalGroup = default, bool hasAccessToAllBuilds = default, bool publicLinkEnabled = default, string publicLinkId = default, bool publicLinkLimitEnabled = default, int publicLinkLimit = default, string publicLink = default, bool feedbackEnabled = default, bool iosBuildsAvailableForAppleSiliconMac = default, bool iosBuildsAvailableForAppleVision = default)
        {
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets IosBuildsAvailableForAppleVision
        /// </summary>
        [DataMember(Name = "iosBuildsAvailableForAppleVision", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IosBuildsAvailableForAppleVision: ").Append(IosBuildsAvailableForAppleVision).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
