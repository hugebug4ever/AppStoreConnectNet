...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class MetricsInsightPopulationsInner : IValidatableObject
    {
        ...
        public MetricsInsightPopulationsInner(decimal deltaPercentage = default, string percentile = default, string summaryString = default, decimal referenceAverageValue = default, decimal latestVersionValue = default, string device = default)
        {
