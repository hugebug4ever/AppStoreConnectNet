...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AlternativeDistributionPackageVersionAttributes : IValidatableObject
    {
        ...
        public AlternativeDistributionPackageVersionAttributes(string url = default, DateTimeOffset urlExpirationDate = default, string varVersion = default, string fileChecksum = default, StateEnum? state = default)
        {
            this.Url = url;
