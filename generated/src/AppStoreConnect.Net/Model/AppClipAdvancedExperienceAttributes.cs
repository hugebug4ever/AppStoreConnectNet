...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppClipAdvancedExperienceAttributes : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public AppClipAdvancedExperienceAttributes(string link = default, int varVersion = default, StatusEnum? status = default, AppClipAction? action = default, bool isPoweredBy = default, AppClipAdvancedExperienceAttributesPlace place = default, PlaceStatusEnum? placeStatus = default, BusinessCategoryEnum? businessCategory = default, AppClipAdvancedExperienceLanguage? defaultLanguage = default)
        {
            this.Link = link;
