...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterPlayerAchievementSubmissionAttributes : IValidatableObject
    {
        ...
        public GameCenterPlayerAchievementSubmissionAttributes(string bundleId = default, List<string> challengeIds = default, int percentageAchieved = default, string scopedPlayerId = default, DateTimeOffset submittedDate = default, string vendorIdentifier = default)
        {
