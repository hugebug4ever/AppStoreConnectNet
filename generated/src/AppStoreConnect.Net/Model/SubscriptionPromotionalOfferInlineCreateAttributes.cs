...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionPromotionalOfferInlineCreateAttributes : IValidatableObject
    {
        ...
        public SubscriptionPromotionalOfferInlineCreateAttributes(SubscriptionOfferDuration duration = default, string name = default, int numberOfPeriods = default, string offerCode = default, SubscriptionOfferMode offerMode = default)
        {
