...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class CiTestDestination : IValidatableObject
    {
        ...
        public CiTestDestination(string deviceTypeName = default, string deviceTypeIdentifier = default, string runtimeName = default, string runtimeIdentifier = default, CiTestDestinationKind? kind = default)
        {
