...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ProfileAttributes : IValidatableObject
    {
        ...
        public ProfileAttributes(string name = default, BundleIdPlatform? platform = default, ProfileTypeEnum? profileType = default, ProfileStateEnum? profileState = default, string profileContent = default, string uuid = default, DateTimeOffset createdDate = default, DateTimeOffset expirationDate = default)
        {
            this.Name = name;
