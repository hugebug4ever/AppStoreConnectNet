...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        public User(TypeEnum type = default, string id = default, UserAttributes attributes = default, UserInvitationRelationships relationships = default, ResourceLinks links = default)
        {
            this.Type = type;
