...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BetaLicenseAgreementUpdateRequestData : IValidatableObject
    {
        ...
        public BetaLicenseAgreementUpdateRequestData(TypeEnum type = default, string id = default, BetaLicenseAgreementUpdateRequestDataAttributes attributes = default)
        {
            this.Type = type;
