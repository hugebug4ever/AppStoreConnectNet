...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterLeaderboardLocalizationCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardLocalizationCreateRequestDataAttributes(string locale = default, string name = default, GameCenterLeaderboardFormatter? formatterOverride = default, string formatterSuffix = default, string formatterSuffixSingular = default, string description = default)
        {
