...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class ErrorResponseErrorsInner : IValidatableObject
    {
        ...
        public ErrorResponseErrorsInner(string id = default, string status = default, string code = default, string title = default, string detail = default, ErrorResponseErrorsInnerSource source = default, ErrorLinks links = default, Dictionary<string, Object> meta = default)
        {
