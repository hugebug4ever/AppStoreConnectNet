...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppPreviewSet_relationships_appStoreVersionLocalization")]
    public partial class AppPreviewSetRelationshipsAppStoreVersionLocalization : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppPreviewSetRelationshipsAppStoreVersionLocalization" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public AppPreviewSetRelationshipsAppStoreVersionLocalization(AppPreviewSetRelationshipsAppStoreVersionLocalizationData data = default)
        {
            this.Data = data;
        }
