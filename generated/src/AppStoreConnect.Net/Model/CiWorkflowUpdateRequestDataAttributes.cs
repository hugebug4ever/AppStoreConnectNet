...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CiWorkflowUpdateRequest_data_attributes")]
    public partial class CiWorkflowUpdateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public CiWorkflowUpdateRequestDataAttributes(string name = default, string description = default, CiBranchStartCondition branchStartCondition = default, CiTagStartCondition tagStartCondition = default, CiPullRequestStartCondition pullRequestStartCondition = default, CiScheduledStartCondition scheduledStartCondition = default, CiManualBranchStartCondition manualBranchStartCondition = default, CiManualTagStartCondition manualTagStartCondition = default, CiManualPullRequestStartCondition manualPullRequestStartCondition = default, List<CiAction> actions = default, bool? isEnabled = default, bool? isLockedForEditing = default, bool? clean = default, string containerFilePath = default)
        {
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "containerFilePath", EmitDefaultValue = true)]
