...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppInfoLocalizationUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public AppInfoLocalizationUpdateRequestDataAttributes(string name = default, string subtitle = default, string privacyPolicyUrl = default, string privacyChoicesUrl = default, string privacyPolicyText = default)
        {
            this.Name = name;
