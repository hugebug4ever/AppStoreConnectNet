...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class BuildBundleFileSizeAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public BuildBundleFileSizeAttributes(string deviceModel = default, string osVersion = default, int downloadBytes = default, int installBytes = default)
        {
