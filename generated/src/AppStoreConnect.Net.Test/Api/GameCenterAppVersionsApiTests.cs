...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class GameCenterAppVersionsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GameCenterAppVersionsAppStoreVersionGetToOneRelationship
        /// </summary>
        [Fact]
        public void GameCenterAppVersionsAppStoreVersionGetToOneRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GameCenterAppVersionsAppStoreVersionGetToOneRelationship(id);
            //Assert.IsType<GameCenterAppVersionAppStoreVersionLinkageResponse>(response);
        }
