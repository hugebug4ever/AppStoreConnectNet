...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class GameCenterLeaderboardSetMemberLocalizationsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardGetToOneRelationship
        /// </summary>
        [Fact]
        public void GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardGetToOneRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardGetToOneRelationship(id);
            //Assert.IsType<GameCenterLeaderboardSetMemberLocalizationGameCenterLeaderboardLinkageResponse>(response);
        }
        ...
        /// <summary>
        /// Test GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardSetGetToOneRelationship
        /// </summary>
        [Fact]
        public void GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardSetGetToOneRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GameCenterLeaderboardSetMemberLocalizationsGameCenterLeaderboardSetGetToOneRelationship(id);
            //Assert.IsType<GameCenterLeaderboardSetMemberLocalizationGameCenterLeaderboardSetLinkageResponse>(response);
        }
