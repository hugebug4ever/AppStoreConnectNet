...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class AnalyticsReportRequestsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AnalyticsReportRequestsReportsGetToManyRelationship
        /// </summary>
        [Fact]
        public void AnalyticsReportRequestsReportsGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.AnalyticsReportRequestsReportsGetToManyRelationship(id, limit);
            //Assert.IsType<AnalyticsReportRequestReportsLinkagesResponse>(response);
        }
    }
}
