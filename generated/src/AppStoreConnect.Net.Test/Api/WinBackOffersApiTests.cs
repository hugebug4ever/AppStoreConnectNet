...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class WinBackOffersApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test WinBackOffersPricesGetToManyRelationship
        /// </summary>
        [Fact]
        public void WinBackOffersPricesGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.WinBackOffersPricesGetToManyRelationship(id, limit);
            //Assert.IsType<WinBackOfferPricesLinkagesResponse>(response);
        }
