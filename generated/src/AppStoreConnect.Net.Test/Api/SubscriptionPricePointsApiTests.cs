...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class SubscriptionPricePointsApiTests : IDisposable
    {
        ...
        public void SubscriptionPricePointsEqualizationsGetToManyRelatedTest()
        {
            ...
            //var response = instance.SubscriptionPricePointsEqualizationsGetToManyRelated(id, filterTerritory, filterSubscription, fieldsSubscriptionPricePoints, fieldsTerritories, limit, include);
            //Assert.IsType<SubscriptionPricePointsResponse>(response);
        }

        /// <summary>
        /// Test SubscriptionPricePointsEqualizationsGetToManyRelationship
        /// </summary>
        [Fact]
        public void SubscriptionPricePointsEqualizationsGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.SubscriptionPricePointsEqualizationsGetToManyRelationship(id, limit);
            //Assert.IsType<SubscriptionPricePointEqualizationsLinkagesResponse>(response);
        }
