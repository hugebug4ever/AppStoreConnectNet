...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class AppCategoriesApiTests : IDisposable
    {
        ...
        public void AppCategoriesParentGetToOneRelatedTest()
        {
            ...
            //Assert.IsType<AppCategoryWithoutIncludesResponse>(response);
        }

        /// <summary>
        /// Test AppCategoriesParentGetToOneRelationship
        /// </summary>
        [Fact]
        public void AppCategoriesParentGetToOneRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.AppCategoriesParentGetToOneRelationship(id);
            //Assert.IsType<AppCategoryParentLinkageResponse>(response);
        }
        ...
        public void AppCategoriesSubcategoriesGetToManyRelatedTest()
        {
            ...
            //Assert.IsType<AppCategoriesWithoutIncludesResponse>(response);
        }

        /// <summary>
        /// Test AppCategoriesSubcategoriesGetToManyRelationship
        /// </summary>
        [Fact]
        public void AppCategoriesSubcategoriesGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.AppCategoriesSubcategoriesGetToManyRelationship(id, limit);
            //Assert.IsType<AppCategorySubcategoriesLinkagesResponse>(response);
        }
    }
}
