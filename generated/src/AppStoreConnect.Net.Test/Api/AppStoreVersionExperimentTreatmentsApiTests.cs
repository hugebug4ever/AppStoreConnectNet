...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class AppStoreVersionExperimentTreatmentsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AppStoreVersionExperimentTreatmentsAppStoreVersionExperimentTreatmentLocalizationsGetToManyRelationship
        /// </summary>
        [Fact]
        public void AppStoreVersionExperimentTreatmentsAppStoreVersionExperimentTreatmentLocalizationsGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.AppStoreVersionExperimentTreatmentsAppStoreVersionExperimentTreatmentLocalizationsGetToManyRelationship(id, limit);
            //Assert.IsType<AppStoreVersionExperimentTreatmentAppStoreVersionExperimentTreatmentLocalizationsLinkagesResponse>(response);
        }
        ...
        public void AppStoreVersionExperimentTreatmentsGetInstanceTest()
        {
            ...
            //var response = instance.AppStoreVersionExperimentTreatmentsGetInstance(id, fieldsAppStoreVersionExperimentTreatments, fieldsAppStoreVersionExperimentTreatmentLocalizations, include, limitAppStoreVersionExperimentTreatmentLocalizations);
            //Assert.IsType<AppStoreVersionExperimentTreatmentResponse>(response);
        }
