...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class AlternativeDistributionPackagesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AlternativeDistributionPackagesVersionsGetToManyRelationship
        /// </summary>
        [Fact]
        public void AlternativeDistributionPackagesVersionsGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.AlternativeDistributionPackagesVersionsGetToManyRelationship(id, limit);
            //Assert.IsType<AlternativeDistributionPackageVersionsLinkagesResponse>(response);
        }
    }
}
