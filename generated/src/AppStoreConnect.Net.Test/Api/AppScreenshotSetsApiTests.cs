...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class AppScreenshotSetsApiTests : IDisposable
    {
        ...
        public void AppScreenshotSetsAppScreenshotsGetToManyRelatedTest()
        {
            ...
            //var response = instance.AppScreenshotSetsAppScreenshotsGetToManyRelated(id, fieldsAppScreenshots, fieldsAppScreenshotSets, limit, include);
        ...
        public void AppScreenshotSetsGetInstanceTest()
        {
            ...
            //var response = instance.AppScreenshotSetsGetInstance(id, fieldsAppScreenshotSets, fieldsAppScreenshots, include, limitAppScreenshots);
            //Assert.IsType<AppScreenshotSetResponse>(response);
        }
    }
}
