...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class CiWorkflowsApiTests : IDisposable
    {
        ...
        public void CiWorkflowsBuildRunsGetToManyRelatedTest()
        {
            ...
            //var response = instance.CiWorkflowsBuildRunsGetToManyRelated(id, filterBuilds, sort, fieldsCiBuildRuns, fieldsBuilds, fieldsCiWorkflows, fieldsCiProducts, fieldsScmGitReferences, fieldsScmPullRequests, limit, include, limitBuilds);
            //Assert.IsType<CiBuildRunsResponse>(response);
        }

        /// <summary>
        /// Test CiWorkflowsBuildRunsGetToManyRelationship
        /// </summary>
        [Fact]
        public void CiWorkflowsBuildRunsGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.CiWorkflowsBuildRunsGetToManyRelationship(id, limit);
            //Assert.IsType<CiWorkflowBuildRunsLinkagesResponse>(response);
        }
        ...
        public void CiWorkflowsGetInstanceTest()
        {
            ...
            //List<string>? include = null;
            //var response = instance.CiWorkflowsGetInstance(id, fieldsCiWorkflows, fieldsScmRepositories, include);
            //Assert.IsType<CiWorkflowResponse>(response);
        }
        ...
        public void CiWorkflowsRepositoryGetToOneRelatedTest()
        {
            ...
            //List<string>? fieldsScmGitReferences = null;
            //List<string>? include = null;
            //var response = instance.CiWorkflowsRepositoryGetToOneRelated(id, fieldsScmRepositories, fieldsScmProviders, fieldsScmGitReferences, include);
            //Assert.IsType<ScmRepositoryResponse>(response);
        }

        /// <summary>
        /// Test CiWorkflowsRepositoryGetToOneRelationship
        /// </summary>
        [Fact]
        public void CiWorkflowsRepositoryGetToOneRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.CiWorkflowsRepositoryGetToOneRelationship(id);
            //Assert.IsType<CiWorkflowRepositoryLinkageResponse>(response);
        }
