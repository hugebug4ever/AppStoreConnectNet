...
namespace AppStoreConnect.Net.Test.Api
{
    ...
    public class SubscriptionOfferCodesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test SubscriptionOfferCodesCustomCodesGetToManyRelationship
        /// </summary>
        [Fact]
        public void SubscriptionOfferCodesCustomCodesGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.SubscriptionOfferCodesCustomCodesGetToManyRelationship(id, limit);
            //Assert.IsType<SubscriptionOfferCodeCustomCodesLinkagesResponse>(response);
        }
        ...
        public void SubscriptionOfferCodesGetInstanceTest()
        {
            ...
            //var response = instance.SubscriptionOfferCodesGetInstance(id, fieldsSubscriptionOfferCodes, fieldsSubscriptionOfferCodeOneTimeUseCodes, fieldsSubscriptionOfferCodeCustomCodes, fieldsSubscriptionOfferCodePrices, include, limitCustomCodes, limitOneTimeUseCodes, limitPrices);
            //Assert.IsType<SubscriptionOfferCodeResponse>(response);
        }
        ...
        public void SubscriptionOfferCodesOneTimeUseCodesGetToManyRelatedTest()
        {
            ...
            //int? limit = null;
            //List<string>? include = null;
            //var response = instance.SubscriptionOfferCodesOneTimeUseCodesGetToManyRelated(id, fieldsSubscriptionOfferCodeOneTimeUseCodes, fieldsSubscriptionOfferCodes, limit, include);
            //Assert.IsType<SubscriptionOfferCodeOneTimeUseCodesResponse>(response);
        }

        /// <summary>
        /// Test SubscriptionOfferCodesOneTimeUseCodesGetToManyRelationship
        /// </summary>
        [Fact]
        public void SubscriptionOfferCodesOneTimeUseCodesGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.SubscriptionOfferCodesOneTimeUseCodesGetToManyRelationship(id, limit);
            //Assert.IsType<SubscriptionOfferCodeOneTimeUseCodesLinkagesResponse>(response);
        }
        ...
        public void SubscriptionOfferCodesPricesGetToManyRelatedTest()
        {
            ...
            //int? limit = null;
            //List<string>? include = null;
            //var response = instance.SubscriptionOfferCodesPricesGetToManyRelated(id, filterTerritory, fieldsSubscriptionOfferCodePrices, fieldsTerritories, fieldsSubscriptionPricePoints, limit, include);
            //Assert.IsType<SubscriptionOfferCodePricesResponse>(response);
        }

        /// <summary>
        /// Test SubscriptionOfferCodesPricesGetToManyRelationship
        /// </summary>
        [Fact]
        public void SubscriptionOfferCodesPricesGetToManyRelationshipTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //int? limit = null;
            //var response = instance.SubscriptionOfferCodesPricesGetToManyRelationship(id, limit);
            //Assert.IsType<SubscriptionOfferCodePricesLinkagesResponse>(response);
        }
