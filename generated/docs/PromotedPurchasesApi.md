...
> PromotedPurchaseResponse PromotedPurchasesGetInstance (string id, List<string>? fieldsPromotedPurchases = null, List<string>? include = null)
...
namespace Example
{
    public class PromotedPurchasesGetInstanceExample
    {
        public static void Main()
        {
            ...
            try
            {
                PromotedPurchaseResponse result = apiInstance.PromotedPurchasesGetInstance(id, fieldsPromotedPurchases, include);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<PromotedPurchaseResponse> response = apiInstance.PromotedPurchasesGetInstanceWithHttpInfo(id, fieldsPromotedPurchases, include);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
